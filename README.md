...
$ cd backend
```
1. Install MongoDB Compass (MongoDB GUI)
2. Create database named "ToDo"
3. Create a cluster named "todos" in the "ToDo" database
4. Copy and paste the connection string in the ".env" file inside backend directory
```bash
#Go into backend
$ cd backend
```
